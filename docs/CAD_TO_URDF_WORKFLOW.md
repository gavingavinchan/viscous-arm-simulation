...
- **Collisions:** use an appropriate approximation for each substantial physical part. Here the builder creates a separate convex hull per solid. A single hull for the entire link could fill the space between brackets.
